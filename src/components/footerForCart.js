...
// const FooterForCart = () => {
//   return (
//     <footer className="bg-footerBackground text-white md:px-4 w-full lg:px-4 py-4 md:w-full m-auto  lg:w-full rounded-[10px] ">
...
const FooterForCart = () => {
  return (
    <footer className="bg-footerBackground text-white w-full py-4 rounded-[10px] mt-auto">
