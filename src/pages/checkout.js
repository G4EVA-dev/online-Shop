...
//   return (
//     <div className="container w-full mt-16 mx-auto p-4  md:rounded-lg md:p-10">
//       <div className="mb-12">
//         <h1 className="text-3xl font-bold">Check Out</h1>
//       </div>

//       <div className="flex flex-col lg:flex-row gap-5">
//         <div className="left w-full lg:w-1/2 border md:border md:border-black border-black p-10 rounded-lg md:border-0">
//           <h1 className="text-xl font-medium mb-8">
//             Select how to receive your package(s)
//           </h1>
...
//                 htmlFor="choice1"
//                 className={`radio-label ${
//                   selectedRadio === "Old Secreteriat Complex, Area 1, Garki Abaji Abji" ? "radio-selected" : ""
//                 }`}
//               >
//                 <span className="radio-custom"></span>
//                 Old Secreteriat Complex, Area 1, Garki Abaji Abji
...
//                 htmlFor="choice2"
//                 className={`radio-label ${
//                   selectedRadio === "Sokoto Street, Area 1, Garki Area 1 AMAC" ? "radio-selected" : ""
//                 }`}
//               >
//                 <span className="radio-custom"></span>
//                 Sokoto Street, Area 1, Garki Area 1 AMAC
